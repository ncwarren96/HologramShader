...
public class BloomandGlow : MonoBehaviour 
{
	...
	[Range(1,7)]public int iterations = 1;
	...
	void OnRenderImage(RenderTexture source, RenderTexture destination)
	{
		...
		//downsampling the source texture to half resoulituoin 
		...
		//blit from the source to the temporary texture, then from the temporary texture to the destination texture
		//, creating a blur effect, then release the temporary texture to make it avaliable for reuse 
